...
class EIGP114BarcodeScanResult implements BarcodeScanResultInterface
{
    ...
    */
    ...
    public function __construct(public readonly array $data)
    {
        ...
        //Note: readonly vars can be set only once, but not necessarily in the c'tor
        //$this->vendorSKU = null;
        //$this->productionDate = null;
        //ID '6D' (shipDate) is actually part of the stardard, but not all vendors use it correctly
        //$this->shipDate = null;
        $this->vendor = $this->guessBarcodeVendorAndNonstandardFields();
    }
     ...
     */
    public function guessBarcodeVendorAndNonstandardFields(): ?string
    {
    ...
    public function getDecodedForInfoMode(): array
    {
        $tmp = [
            ...
            //'Guessed vendor from barcode' => $this->vendor,
        ];
